 ...
 */
function getCommands(commandParser) {
 ...
 *                  arguments, options
 */
function getCommandOptions(command, subCommand, commandParser) {
 ...
 */
function filterInput(inputArray) {
 ...
 */
function filterCompletionOptions(input, currentInput, options) {
 ...
 *                         optionalArguments, options
 */
function completeOptions(input, options) {
 ...
 */
function filterCompletionCommands(currentInput, commands) {
  var i, commandsLen;
 ...
 */
function complete(argv, commandParser) {
